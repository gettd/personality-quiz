...
const questions = [
  {
    ...
    text: "ตะวันเช้าทอแสงอ่อนผ่านม่านหมอกแห่งขุนเขา รถบัสลูกเสือกำลังไต่ทางลาดขึ้นสู่สถานที่ลับแห่งหนึ่งที่ไม่มีระบุใน Google Maps ผู้คนรอบข้างเต็มไปด้วยเสียงหัวเราะ กลิ่นไอของความตื่นเต้นลอยอบอวลระหว่างเพื่อนใหม่ที่เพิ่งรู้จัก นักเรียนนั่งริมหน้าต่าง รถโยกทุกครั้งเหมือนพานักเรียนสู่โลกใหม่... แล้วนักเรียนเลือกทำอะไรเพื่อเติมพลังใจระหว่างการเดินทางอันแสนยาวไกล?",
    answers: [
  ...
  },
  {
    ...
    text: "เดินทางถึงค่ายแล้ว! ผู้กำกับลูกเสือให้แผนที่เก่าๆ ที่มีสัญลักษณ์แปลกๆ นักเรียนจะทำอย่างไร?",
    answers: [
  ...
  },
  {
    ...
    text: "ถึงเวลาตั้งเต็นท์! นักเรียนจะทำหน้าที่ไหน?",
    answers: [
  ...
  },
  {
    ...
    text: "ค่ำคืนแรก ต้องจุดกองไฟเพื่อทำอาหารและให้ความอบอุ่น นักเรียนจะช่วยเพื่อนในหมู่อย่างไร?",
    answers: [
  ...
  },
  {
    ...
    text: "ระหว่างทางขึ้นสู่ยอดเขา... มีแสงพระอาทิตย์ขึ้นนักเรียนจะเลือกใช้เวลาเช้านี้อย่างไร?",
    answers: [
  ...
  },
  {
    ...
    text: "ระหว่างเดินป่า หมู่ของนักเรียนหลงทาง จะแก้ปัญหาอย่างไร?",
    answers: [
  ...
  },
  {
    ...
    text: "เจอเห็ดสีสันสวยงามในป่า นักเรียนจะทำอย่างไร?",
    answers: [
  ...
  },
  {
    ...
    text: "เจอลำธารขวางทาง ต้องหาวิธีข้ามไปอีกฝั่ง นักเรียนจะทำอย่างไร?",
    answers: [
  ...
  },
  {
    ...
    text: "เจอนกสายพันธุ์หายากบนต้นไม้ นักเรียนจะทำอย่างไร?",
    answers: [
  ...
  },
  {
    ...
    text: "เที่ยงแล้ว! ต้องทำอาหารกลางวันในป่า นักเรียนจะช่วยอย่างไร?",
    answers: [
  ...
  },
  {
    ...
    text: "คืนวันที่สอง มีเกมสนุกๆ นักเรียนชอบเล่นเกมแบบไหน?",
    answers: [
  ...
  },
  {
    ...
    text: "ก่อนนอน หัวหน้าให้ทุกคนเล่าเรื่อง นักเรียนจะเล่าเรื่องแบบไหน?",
    answers: [
  ...
  },
  {
    ...
    text: "ก่อนที่ขาจะก้าวสู่ก้อนหินแรก นักเรียนเตรียมตัวอย่างไร?",
    answers: [
  ...
  },
  {
    ...
    text: "กำลังปีนอยู่ มีอุปสรรคมากมาย นักเรียนจะทำอย่างไร?",
    answers: [
  ...
  },
  {
    ...
    text: "สำเร็จแล้ว! ถึงยอดเขา นักเรียนรู้สึกอย่างไรและจะทำอะไร?",
    answers: [
  ...
  },
  {
    ...
    text: "บนยอดเขามีกล่องเก่าๆ ข้างในมีจดหมายเขียนด้วยรหัส นักเรียนจะทำอย่างไร?",
    answers: [
      ...
      { text: "ปรึกษาเพื่อนในกลุ่มเพื่อระดมสมองและช่วยกันไขปริศนา", type: TYPES.SOCIAL },
      { text: "เชื่อในลางสังหรณ์แรกของตัวเองว่าข้อความนี้น่าจะสื่อถึงอะไร", type: TYPES.SELF },
      { text: "สังเกตวัสดุกระดาษหรือหมึกว่าทำมาจากพืชหรือยางไม้ชนิดใด", type: TYPES.NATURE }
    ]
  },
  {
    title: "สถานการณ์ที่ 17: รางวัลแห่งความสำเร็จ",
    image: "scenario-images/17.png",
    text: "เมื่อถอดรหัสได้สำเร็จ พบว่ามันนำไปสู่ 'รางวัลทางใจ' นักเรียนคิดว่ารางวัลนั้นคืออะไรสำหรับนักเรียน?",
    answers: [
  ...
  },
  {
    ...
    text: "ได้เวลากลับลงมาแล้ว ทางลงค่อนข้างชันและลื่น นักเรียนจะใช้วิธีไหน?",
    answers: [
  ...
  },
  {
    ...
    text: "กลับถึงค่ายหลัก ต้องรื้อถอนเต็นท์และเก็บของ นักเรียนจะช่วยอย่างไร?",
    answers: [
  ...
  },
  {
    ...
    text: "ก่อนขึ้นรถบัส ผู้กำกับให้ทุกคนกล่าวลาป่าแห่งนี้ นักเรียนจะทำอย่างไร?",
    answers: [
  ...
  },
  {
    ...
    text: "กิจกรรมแก้เบื่อระหว่างนั่งรถกลับ ร่างกายเริ่มเหนื่อยล้า นักเรียนเลือกทำอะไร?",
    answers: [
  ...
  },
  {
    ...
    text: "ใกล้ถึงโรงเรียนแต่รถติดหนักมาก ทุกคนเริ่มหงุดหงิด นักเรียนจะทำอย่างไร?",
    answers: [
  ...
  },
  {
    ...
    text: "รถจอดเทียบค่ายที่โรงเรียน ทุกคนต้องขนของลง นักเรียนจะทำอะไร?",
    answers: [
  ...
  },
  {
    ...
    text: "คุณแม่ถามว่า 'ไปค่ายเป็นยังไงบ้างลูก?' นักเรียนจะตอบหรือทำอะไรเป็นอย่างแรก?",
    answers: [
  ...
  },
  {
    ...
    text: "ครูให้การบ้านชิ้นสุดท้าย คือ 'สรุปสิ่งที่ประทับใจที่สุด' งานแบบไหนที่นักเรียนถนัด",
    answers: [
  ...
  },
  {
    ...
    text: "สิ่งที่เปลี่ยนไปในตัวนักเรียน หลังจากจบค่ายนี้คืออะไร?",
    answers: [
  ...
  },
  {
    ...
    text: "ถ้าได้เป็นคนเลือกสถานที่ค่ายครั้งหน้า นักเรียนจะเสนอที่ไหน?",
    answers: [
